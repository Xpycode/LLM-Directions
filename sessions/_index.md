...
|------|-------|---------|-----|
| 2026-09-01 | Make Directions first-class for Codex with an accurate AGENTS.md and dual-tool setup guidance | Replaced the placeholder with a Codex entry point, added a reusable template, aligned setup/docs, preserved live commands as the shared source, and passed consistency plus independent review. Next: exercise the workflows in real Codex projects. | [log](2026-09-01.md) |
