...
|------|-------|---------|-----|
| 2026-09-10 | Native acquisition and later-boot preparation; M1 Max arrival | Kernel capture and separate-process reload passed; marker unchanged. Persistent library staged; retained-evidence inspection independently reviewed. Preserve successful acquisition and five failures. Next: arrange same-Mac restart; Gate A open. | [log](2026-09-10.md) |
