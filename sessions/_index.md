...
|------|-------|---------|-----|
| 2026-09-10 | Wave 1 kernel-inventory review; M1 Max arrival | Isolated C prototype: 19 tests and independent review passed. Reproduced shared-lock root split with private fixtures; resolve trusted root selection before integration. Earlier five capture failures preserved; no native retry. Gate A blocked. | [log](2026-09-10.md) |
