...
|------|-------|---------|-----|
| 2026-09-10 | Shared runtime root and kernel inventory; M1 Max arrival | Fixed shared-root selection; opt-in adapter reviewed, 456 broad passes/one skip. One native read-only check passed, marker unchanged. Fresh acquisition prepared/reviewed; storage scope pending. Five failed transactions preserved; Gate A open. | [log](2026-09-10.md) |
