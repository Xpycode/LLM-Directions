...
|------|-------|---------|-----|
| 2026-09-10 | Wave 1 identity diagnostics and native observation; M1 Max arrival | 397 tests passed/one skip; independent review passed. One native observation reported ESRCH during identity scan; marker unchanged, no capture/retry. Next inventory completeness/stability contract review; task 1.3/Gate A blocked. | [log](2026-09-10.md) |
