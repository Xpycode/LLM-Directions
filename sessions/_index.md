...
|------|-------|---------|-----|
| 2026-09-09 | Native acquisition failures and safe probe diagnostics | Both captures failed before baseline retention; fresh failure localized to inventoryAfterFirstScan. 367 passed/1 skip; 14 final probe tests passed. Next: inventory-boundary diagnosis. Transactions preserved; Gate A open. 22 Backlog, 0 Inbox. | [log](2026-09-09.md) |
