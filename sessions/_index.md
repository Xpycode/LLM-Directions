...
|------|-------|---------|-----|
| 2026-09-10 | Wave 1 acquisition diagnostics and authorized native capture; M1 Max arrival | Offline fixes: 386 passes/one skip; fresh caller 23 passes and review passed. Authorized capture failed at observation 3 first identity read after retention; no reload/retry. Next offline adapter review; Gate A open. | [log](2026-09-10.md) |
