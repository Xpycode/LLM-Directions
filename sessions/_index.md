...
|------|-------|---------|-----|
| 2026-09-10 | Wave 1 acquisition review and offline reporting fixes; M1 Max arrival | Native capture failed after retention. Reviewed/fixed diagnostics and timeout reporting; 386 tests passed/one skip, independent review passed. No retry; Gate A open. Next prepare/review fresh caller configuration before separate native scope. | [log](2026-09-10.md) |
