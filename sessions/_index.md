...
|------|-------|---------|-----|
| 2026-09-10 | Wave 1 inventory contract and native capture; M1 Max arrival | 406 broad passes/one skip; 29 final focused passes and independent review. Native probe passed; capture failed on inventory change after retention. Five failures preserved, no reload/retry. Next inventory-change contract review; Gate A blocked. | [log](2026-09-10.md) |
