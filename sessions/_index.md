...
|------|-------|---------|-----|
| 2026-09-10 | Wave 1 acquisition diagnostics and fresh caller preparation; M1 Max arrival | Offline fixes: 386 passes/one skip. Fresh caller: location inspection, 23 focused tests and independent review passed. Capture/reload awaits separate native scope; recovery and Gate A remain open. | [log](2026-09-10.md) |
