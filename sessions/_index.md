...
|------|-------|---------|-----|
| 2026-06-07 | Main-menu house-style + Directions copy-vs-drift fix (spilled from zPackages) | Drafted `46_main-menu.md` (main menu = complete command inventory). **Uncommitted.** Diagnosed copy-vs-drift flaw → proposed Index-in-global-CLAUDE.md + `/setup` change. **Decisions parked — see RESUME.md.** | [log](sessions/2026-06-07.md) |
