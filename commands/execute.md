...
Check for `IMPLEMENTATION_PLAN.md` in project root. If missing, ask the user what to implement and create one:
...
- Specific task description from IMPLEMENTATION_PLAN.md
...
3. Update IMPLEMENTATION_PLAN.md checkboxes to [x]
...
4. Delete IMPLEMENTATION_PLAN.md (it's done)
...
4. **State lives in files** - IMPLEMENTATION_PLAN.md and PROJECT_STATE.md are source of truth.

## Quick Start

If user just typed `/execute` with no prior IMPLEMENTATION_PLAN.md:
> "No IMPLEMENTATION_PLAN.md found. What would you like to implement? I'll create an execution plan with parallel waves."
