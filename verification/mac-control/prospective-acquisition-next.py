"""Fresh September 10 caller prepared for separate native scope; not yet run.

Prepared from prospective-acquisition-wrapper.py with fresh transaction/report
names and operator record. Run only within separately agreed native scope. Merely importing this file performs
...
TXN = 'acquisition-586afa02a34e4ea9b0ff8290f847bd4d'
...
REPORT = REPO / 'verification/mac-control/prospective-acquisition-586afa02a34e4ea9b0ff8290f847bd4d.jsonl'
...
operations = [('capture', base + ['capture', *common, '--marker-directory', str(MARKER),
    ...
    '2026-09-10 Wave 1 follow-up after final-observation diagnostics and append-only reporting review: new prospective baseline; preserve all three prior failed transactions; original report pins not found; historical crash copy acquired now as failed/unknown, non-retryable context.']),
